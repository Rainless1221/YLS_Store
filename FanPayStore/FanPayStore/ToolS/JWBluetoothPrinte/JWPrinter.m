...
#pragma mark - 一鹿省的商品
- (void)YLSappendLeftText:(NSString *)left  alignment:(HLTextAlignment)alignment fontSize:(HLFontSize)fontSize isTitle:(BOOL)isTitle{
    [self setAlignment:alignment];
    // 2.设置字号
    [self setFontSize:fontSize];
    [self setText:left maxChar:50];
