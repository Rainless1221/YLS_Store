...
/**
 ...
 @param badgeValue 加角标
 */
- (void)setBadgeValue:(NSInteger)badgeValue Hidden:(BOOL )ishid{
    ...
    badgeLable.textColor = [UIColor redColor];
...
//    badgeLable.frame = CGRectMake(badgeX, badgeY, badgeW, badgeW);
    badgeLable.frame = CGRectMake(0, 0, badgeW, badgeW);

    UIView *labelView = [[UIView alloc]initWithFrame:CGRectMake(badgeX, badgeY, badgeW, badgeW)];
    
    [self addSubview:labelView];
    [labelView addSubview:badgeLable];
