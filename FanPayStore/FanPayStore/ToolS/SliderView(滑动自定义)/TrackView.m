...
- (NSArray *)colors{
    if (!_colors || _colors.count<2) {
        _colors = @[(__bridge id)[UIColor colorWithRed:227/255.f green:238/255.f blue:255/255.f alpha:1.0].CGColor,(__bridge id)[UIColor colorWithRed:227/255.f green:238/255.f blue:255/255.f alpha:1.0].CGColor];
    }
    return _colors;
}
