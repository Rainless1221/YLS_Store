...
- (void)setData:(NSDictionary *)Data{
    ...
    NSString *phon = [NSString stringWithFormat:@"%@",Data[@"user_info"][@"mobile"]];
    if ([[MethodCommon judgeStringIsNull:phon] isEqualToString:@""]) {
        ...
        self.user_info.text = [NSString stringWithFormat:@"%@(%@)%@",Data[@"user_info"][@"user_name"],Data[@"user_info"][@"sex"],string];
    }
