...
- (void)keyboardWillChangeFrame:(NSNotification *)noty
{
    ...
    if (self.isFirst) {
        ...
        self.isFirst = YES;
        CGRect bottomFrame = self.backView.frame;
        bottomFrame.size.height =  CGRectGetMaxY(self.BeiZhu.frame)+134;
        bottomFrame.origin.y = self.bounds.size.height - bottomFrame.size.height;
        self.backView.frame = bottomFrame;
    }
...
-(void)createUI{
    ...
    self.backView.frame = CGRectMake(0,308.5,375,358.5);
    ...
    [self.backView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_offset(358.5);
    }];
    UILabel *label1 = [[UILabel alloc] init];
    label1.frame = CGRectMake(15,378.5,254,14);
    ...
    line1.frame = CGRectMake(0,358.5,375,0.5);
    ...
    line2.frame = CGRectMake(0,358.5,375,0.5);
    ...
    [line2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_offset(-134);
        make.left.right.mas_offset(0);
        make.height.mas_offset(1);
    }];
    UILabel *label2 = [[UILabel alloc] init];
    label2.frame = CGRectMake(15,378.5,254,14);
...
-(UITextField *)BeiZhu{
    if (!_BeiZhu) {
        _BeiZhu = [[UITextField alloc]initWithFrame:CGRectMake(0, 0, 150, 40)];
