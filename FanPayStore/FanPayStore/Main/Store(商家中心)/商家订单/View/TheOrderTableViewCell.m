...
@implementation TheOrderTableViewCell

-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        
        self.BaseView = [[UIView alloc]initWithFrame:CGRectMake(15, 15, ScreenW - 30, 390)];
        self.BaseView.backgroundColor = [UIColor whiteColor];
        self.BaseView.layer.cornerRadius =  5;
        self.BaseView.layer.shadowOpacity = 0.2;
        self.BaseView.layer.shadowOffset = CGSizeMake(0, 1.5);
