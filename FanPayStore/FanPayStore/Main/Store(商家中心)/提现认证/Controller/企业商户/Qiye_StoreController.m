...
#import "Qiye_StoreController.h"

@interface Qiye_StoreController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation Qiye_StoreController
...
-(void)merchant_center{
    ...
    [[FBHAppViewModel shareViewModel]get_completion_ysepay_mer_info:model.merchant_id andstore_id:model.store_id Success:^(NSDictionary *resDic) {
        ...
        if ([resDic[@"status"] integerValue]==1) {
            ...
            [dict4 setObject:DIC[@"is_complete_business_license_info"] forKey:@"celltype"];
            [dict4 setObject:DIC[@"bus_license"] forKey:@"cellText1"];
            [dict4 setObject:DIC[@"bus_license_expire"] forKey:@"cellText2"];
            
            
            
            [dict5 setObject:DIC[@"is_complete_customer_agreement_info"] forKey:@"celltype"];
            [dict5 setObject:@"" forKey:@"cellText1"];
            [dict5 setObject:@"" forKey:@"cellText2"];
            
            
            [dict6 setObject:DIC[@"is_complete_opening_permit_info"] forKey:@"celltype"];
            [dict6 setObject:@"" forKey:@"cellText1"];
            [dict6 setObject:@"" forKey:@"cellText2"];
            ...
            [self.Data1 addObject:dict5];
            [self.Data1 addObject:dict6];
