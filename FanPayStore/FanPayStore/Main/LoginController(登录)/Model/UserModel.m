...
//
// 存储用户app账号的路径
#define KUserDataFilePath [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject]stringByAppendingPathComponent:@"UserData.plist"]
...
+(instancetype)getUseData{
    ...
    @try {
        UserModel *userInfo =[NSKeyedUnarchiver unarchiveObjectWithFile:KUserDataFilePath];
        return userInfo;
